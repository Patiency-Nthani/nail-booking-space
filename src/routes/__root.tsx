...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Luxe by Patience" },
      { name: "description", content: "Luxe by Patience — editorial nail studio by PTheNailTech. Book your appointment." },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "Luxe by Patience" },
      { name: "twitter:title", content: "Luxe by Patience" },
      { property: "og:description", content: "Luxe by Patience — editorial nail studio by PTheNailTech. Book your appointment." },
      { name: "twitter:description", content: "Luxe by Patience — editorial nail studio by PTheNailTech. Book your appointment." },
